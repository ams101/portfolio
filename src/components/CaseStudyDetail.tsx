...
const CaseStudyDetail = ({ caseStudyId, onBack }: CaseStudyDetailProps) => {
  const studies = [
    {
      id: 'zo-trips',
      title: 'Zo-Trips at Zostel: building an AI-powered trips business from 0→₹12 Cr GMV',
      ...
      impact: [
        'Grew Zo-Trips from a small upsell widget into a curated trips business doing ~₹12 Cr in annual GMV with ~15% MoM growth',
      ...
      metrics: '₹12 Cr+ GMV | 15% MoM growth',
    },
    {
      id: 'shaadi',
    ...
    },
    {
      ...
      initiatives: [
        ...
        },
        {
          ...
          description: 'Ran implementations for Ultratech Cement and GHCL, from discovery to rollout. Configured workflows and policies to match complex procurement processes. Helped clients achieve 5%+ procurement savings on combined spends exceeding ₹500 Cr.',
        },
        {
  ...
  return (
    <section className="py-24 px-6 bg-slate-50">
      <div className="max-w-5xl mx-auto">
        <button
          onClick={onBack}
          className="flex items-center gap-2 mb-8 px-6 py-3 bg-white text-slate-900 rounded-xl font-medium hover:bg-slate-50 transition-all duration-300 shadow-lg hover:shadow-xl border border-slate-200"
        >
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
            <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-8 py-16 md:px-12 md:py-20 overflow-hidden">
              ...
              <div className="relative">
                <div className="inline-block px-3 py-1 bg-blue-500/10 border border-blue-400/20 text-blue-300 rounded-lg text-xs font-bold mb-6 uppercase tracking-wider">
                  Case Study
                </div>
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
                  {selectedStudy.title}
                </h2>
                <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 backdrop-blur-sm text-white rounded-xl font-bold border border-white/10 shadow-lg">
                ...
                <>
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-2xl font-bold text-slate-900">Context</h3>
                    </div>
                    <p className="text-lg text-slate-700 leading-relaxed pl-9">
                  ...
                  {'role' in selectedStudy && (
                    <div>
                      ...
                      <p className="text-lg text-slate-700 leading-relaxed pl-9 mb-3">
                  ...
                  {'initiatives' in selectedStudy && (
                    <div>
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-2xl font-bold text-slate-900">What I did</h3>
                      </div>
              ...
              {'challenge' in selectedStudy && (
                <>
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <Target className="w-6 h-6 text-slate-700" />
                      <h3 className="text-2xl font-bold text-slate-900">Challenge</h3>
                    </div>
                    <p className="text-lg text-slate-700 leading-relaxed pl-9">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <Lightbulb className="w-6 h-6 text-slate-700" />
                      <h3 className="text-2xl font-bold text-slate-900">Solution</h3>
                    </div>
                    <p className="text-lg text-slate-700 leading-relaxed pl-9">
