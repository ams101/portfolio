      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div key={selectedArticle.id} id={`${selectedArticle.id}-detail`} className="scroll-mt-32">
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
            <div className="relative bg-gradient-to-br from-blue-600 via-cyan-600 to-blue-700 px-8 py-16 md:px-12 md:py-20 overflow-hidden">
            ...
            <div className="p-8 md:p-12">
              <div className="bg-blue-50 rounded-2xl p-6 md:p-8 mb-12 border-l-4 border-blue-600">
                <div className="flex items-center gap-3 mb-4">
                  <Lightbulb className="w-6 h-6 text-blue-600" />
                  <h3 className="text-xl font-bold text-slate-900">Why I wrote this</h3>
                </div>
              ...
              <div className="prose prose-lg prose-slate max-w-none">
                {selectedArticle.content.split('\n\n').map((paragraph, index) => {
                    if (paragraph.startsWith('## ')) {
                      return (
                        <h2 key={index} className="text-3xl font-bold text-slate-900 mt-12 mb-6 pb-3 border-b-2 border-slate-200">
                          {paragraph.replace('## ', '')}
                        </h2>
                      );
                    }
                    if (paragraph.startsWith('**') && paragraph.endsWith('**')) {
                      ...
                      return (
                        <p key={index} className="text-lg text-slate-700 leading-relaxed mb-4 pl-4 border-l-2 border-blue-200">
                          <strong className="font-bold text-slate-900">{bold}:</strong>
